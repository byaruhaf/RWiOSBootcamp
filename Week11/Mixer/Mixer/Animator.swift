...
public extension Animator {
    ...
    static func move(duration: TimeInterval = 3) -> Animator {
        return Animator(duration: duration, closure: {  $0.center = CGPoint(x: 150, y: 150) })
    }
    ...
    static func colorChange(duration: TimeInterval = 3) -> Animator {
        return Animator(duration: duration, closure: {   $0.backgroundColor = UIColor.blue })
    }
}
